...
import styles from './annotations/styles.module.css'

export function MyCode({ codeblock }: { codeblock: RawCode }) {
  console.log(codeblock.lang);
  const codeTitle = codeblock.meta ? codeblock.meta.replace(/title=('|")([^>]+?)('|")/g, '$2')
  return (
    <div className={clsx('theme-code-block', `lang-${codeblock.lang}`)}>
      {codeblock.meta ? (
